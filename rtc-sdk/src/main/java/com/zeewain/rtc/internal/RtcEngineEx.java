...
public abstract class RtcEngineEx extends RtcEngine {
    ...
    private void enableCameraImpl() {
        ...
        try {
            ...
            if (mLocalVideoTrack == null) {
                ...
                mLocalVideoTrack = mPeerConnectionUtils.createVideoTrack(rtcEngineConfig.mContext, "Cam");
    ...
    private void handleNotification(Notification notification) {
        ...
        switch (notification.method) {
            case "ROOM_JOINED":
                rtcEngineConfig.mEventHandler.onJoinChannelSuccess("", rtcEngineConfig.mUserId);
                break;
            case "USER_JOINED":
                String id = jsonData.getString("id");
                rtcEngineConfig.mEventHandler.onUserJoined(id);
                mStore.addPeer(id, jsonData);
                break;
            case "USER_LEFT":
                rtcEngineConfig.mEventHandler.onUserOffline(jsonData.getString("userId"));
...
//            case "ROOM_CLOSED":
            case "USER_CONSUMER_CLOSED":
                ...
                rtcEngineConfig.mEventHandler.onRemoteVideoStateChanged(holder.peerId, holder.mConsumer.getId(), false);
                break;
            case "USERS_ONLINE":
                rtcEngineConfig.mEventHandler.onUserOnline(jsonData.getJSONArray("users"));
                break;
